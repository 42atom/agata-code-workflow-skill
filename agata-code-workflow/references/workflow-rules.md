...
- `[本轮完成，请求下一阶段：动作(文档落盘/实现/审阅/修复/通过/复审/提交/推送/需用户决策..等等)-目标(当前任务/单号/关键字)]`
...
- `[本轮完成，请求下一阶段：实现-tk0061]`
- `[本轮完成，请求下一阶段：审阅-tk0061]`
- `[本轮完成，请求下一阶段：修复-rp0061]`
- `[本轮完成，请求下一阶段：提交-tk0061]`
- `[本轮完成，请求下一阶段：推送-tk0061]`
- `[本轮完成，请求下一阶段：需用户决策-支付降级方案]`
- `[本轮已完成(tk0061)，阶段结束]`
